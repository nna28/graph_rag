...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run SmartGraphRAG backed by Gemini (Google Generative AI API)."
    )
    ...
    parser.add_argument(
        "--output-json",
        default="smart_graph_gemini_results.json",
    ...
    if not os.getenv("GOOGLE_API_KEY"):
        print("GOOGLE_API_KEY is missing; load it in .env or your environment.", file=sys.stderr)

    llm = _build_llm(args.model, args.temperature)
